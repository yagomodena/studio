...
export default function CustomersPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (!customersRef || !userProfile?.companyId) return;
    ...
    const isLoading = isUserLoading || isProfileLoading || isLoadingCustomers;
            ...
            <TableBody>
              {isLoading ? (
                ...
                <TableRow key={customer.id}>
                  ...
                  <TableCell>{(customer.totalSpent || 0).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</TableCell>
