...
const GenerateProductDescriptionInputSchema = z.object({
  ...
  attributes: z
    .string()
    .describe(
      'A comma-separated list of attributes for the product, such as color, size, material, etc.'
    ),
});
...
const prompt = ai.definePrompt({
  ...
  Generate a product description based on the product name and attributes provided.
